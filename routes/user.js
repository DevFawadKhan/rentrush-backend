...
import {Signup,login, test} from "../Controller/users.js";
...
router.post('/signup', [body('ownerName').isLength({min:3}), body("email").isEmail(),body('cnic').isLength({min:13, max:13}), body('contactNumber').isLength({min:11, max:11}), ], Signup);
